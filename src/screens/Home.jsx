...
const Home = () => {
  return (
    <>
      <div style={{ backgroundImage:"url(./assets/back.png)",backgroundSize: "cover" ,backgroundPosition: "center" ,maxWidth: "100%" ,height: "auto"}} className='home-sec'>
        <div className="flex flex-col items-center justify-center min-h-screen "> {/* Update with your image path */}
          <div style={{ width: "90%" , marginTop:"20px" }} className="bg-black bg-opacity-50 text-white text-center p-8 w-full rounded-lg">
            <h1 className="text-2xl text-center md:text-4xl font-bold mb-6">
              WELCOME TO <span className="text-red-500">SONI AUTO MARKET</span>
            </h1>
            ...
            <div className="flex flex-col items-center gap-4 w-full">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 w-full">
                ...
                <button style={{ backgroundColor: '#F40000', padding: '5.50px 20px' }} className="text-white rounded w-36 md:w-48">
>>>>>>> 11a30d3e84a801f3a0d9db239b0dccc8500baaf4
                  Search
                </button>
              </div>
...
<<<<<<< HEAD
              ...
              <button  className="text-white py-2 px-5 rounded hover-btn-sary home-k-btn">
=======
              <button style={{ backgroundColor: '#F40000' }} className="text-white py-2 px-5 rounded hover:bg-red-600">
                Cars less than $5000
              </button>
              <button style={{ backgroundColor: '#F40000' }} className="text-white py-2 px-5 rounded hover:bg-red-600">
                Cars less than $10000
...
=======
            QUICK SEARCH BY<span className="text-red-500">MAKE</span>
          </h1>
        </div>
