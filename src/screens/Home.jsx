                ...
                <div className="flex flex-col items-center justify-center min-h-screen ">
                  ...
                  <span style={{marginBottom: "4px", fontSize: "22px"}}>| </span><i
                                ...
                                <button style={{padding: '10px 30px'}}
                                        className="text-white rounded w-36 md:w-48  search-wala-button hover-btn-sary ">
                                    Search
                                </button>
                            </div>
                        </div>
            ...
            <section className='mt-5 home-background-imgs '>
                ...
                <div className="mt-10 flex justify-center flex-wrap gap-12 py-6">
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/convertible.png.png"
                             alt="Convertible"/>
                        <span className="mt-2 text-center">Convertible</span>
                    </div>
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/coupe.png.png"
                             alt="Coupe"/>
                        <span className="mt-2 text-center">Coupe</span>
                    </div>
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/HATCHBACK.png.png"
                             alt="Hatchback"/>
                        <span className="mt-2 text-center">Hatchback</span>
                    </div>
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/sedan.png.png"
                             alt="Sedan"/>
                        <span className="mt-2 text-center">Sedan</span>
                    </div>
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/suv.png.png"
                             alt="SUV"/>
                        <span className="mt-2 text-center">SUV</span>
                    </div>
                    <div className="flex flex-col items-center mx-2 mb-4">
                        <img className="w-auto max-w-[140px] h-[47px] object-contain" src="./assets/pickup.png.png"
                             alt="Pickup"/>
