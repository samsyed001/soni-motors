        ...
        <>
            <div className="bg-gray-100 p-4 min-h-screen">
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-1/4 bg-white p-4 rounded-lg shadow-md self-start side-bar"
                        ...
                        <form className="space-y-4" style={{marginTop: "-30px"}}>
                            ...
                            <div className="relative w-[100%] mt-6">
                                <select className="w-full p-2 border appearance-none pr-8 text-black"
                                ...
                                <span style={{display: "flex", alignItems: "center", fontSize: "20px", gap: "10px"}}
                                      className="absolute top-1/2 right-3 transform -translate-y-1/2 pointer-events-auto text-black">
                  <span style={{marginBottom: "4px", fontSize: "22px"}}></span><i
                  ...
                  <span style={{marginBottom: "4px", fontSize: "22px"}}></span><i
                                ...
                                <div className="keyword mt-6">
                                    <input className="w-full p-2 border rounded-md" placeholder="KEYWORD SEARCH"
                                           type="text" name="" id=""/>
                                </div>
                            </div>

                            <button
                                className="w-full bg-black text-white p-2 rounded-md flex justify-center items-center">Search
                            </button>
                            <button
                                className="w-full bg-black text-white p-2 rounded-md flex justify-center items-center">Reset
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="md:w-3/4 mt-4 md:mt-0 md:ml-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="relative w-[95%] sm:mt-3 sm:mb-3 toranto">
                                ...
                                <span
                                    className="absolute top-1/2 right-3 transform -translate-y-1/2 pointer-events-none text-red-500">
            <i className="fa-solid fa-angle-down"></i>
                        ...
                        <div className="flex items-center mb-4 btn">
                            <h2 className="text-xl  flex-1 h2-span invent-text">
                                ...
                                <span style={{margin: "0px 4px"}}>Year <span
                                    style={{margin: "0px 6px", fontSize: "20px", fontWeight: "100"}}>|</span></span>
                                <span style={{margin: "0px 4px"}}>Make <span
                                    style={{margin: "0px 6px", fontSize: "20px", fontWeight: "100"}}>|</span></span>
                                <span style={{margin: "0px 4px"}}>Model <span
                                    style={{margin: "0px 6px", fontSize: "20px", fontWeight: "100"}}>|</span></span>
                                <span style={{margin: "0px 4px"}}>BodyStyle <span
                                    style={{margin: "0px 6px", fontSize: "20px", fontWeight: "100"}}>|</span></span>
                                <span style={{margin: "0px 4px"}}>Price <span
                                    style={{margin: "0px 6px", fontSize: "20px", fontWeight: "100"}}>|</span></span>
                            </h2>

                            <div className="flex items-center">
                                <button style={{fontSize: "22.5px"}} className="p-2  rounded hoverr"><i
                                    className="fa-solid fa-list"></i></button>
                                <button className="p-2 bg-gray-100 rounded ml-2"><img src="./assets/Vector (13).png"
                                                                                      alt=""/></button>
                            </div>
                                    ...
                                    return (
                                        <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden pb-5">
                                            ...
                                            <div className="flex gap-1 mt-4">
                                                <button style={{paddingLeft: "10px"}} className=" text-white"><img
                                                    src="./assets/Button (2).png" alt=""/></button>
                                                <button className=" text-white"><img src="./assets/Button (3).png"
                                                                                     alt=""/></button>
                                            </div>
                                            ...
                                            <div className="flex justify-between items-center mt-2 px-4">
                                                <div className="flex items-center mt-2">
                                                    ...
                                                    <label htmlFor={showPrice${index}} className="text-gray-700">Show
                                                        Prices</label>
                                                </div>
                                            ...
                                            <div className="px-4 ">
                                                ...
                                                <div className="flex justify-between items-center mt-2 "
                                                    ...
                                                    <p style={{fontSize: "17px", fontWeight: "700"}}
                                                       className={mt - 1 ${fainance === "Sold" ? "text-red-500": fainance === "Available"? "text-green-500": fainance === "Upcoming"? "text-blue-500": fainance === "Pending"? "text-orange-300": "text-black"}}>
                                                        {fainance}
                                                    </p>
                                                ...
                                                <div className="mt-4 flex justify-between">
                                                    <Link to="/JeepWrangular">
                                                        <button
                                                            className="card-btn border-2 border-red-500 text-black  rounded black-hover">View
                                                            Details
                                                        </button>
                                                    </Link>
                                                    <button
                                                        className="card-btn bg-black text-white  rounded c-btn-2 red-hover">Carfax
                                                        Report
                                                    </button>
                                                </div>
                                            </div>
