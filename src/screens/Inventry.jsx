            ...
            <i className="fa-solid fa-angle-down"></i>
                        ...
                        <div className="flex items-center mb-4 btn">
                            <h2 className="text-xl  flex-1 h2-span invent-text">
                                ...
                                <span style={{margin:"0px 4px" }}>Year <span style={{margin:"0px 6px" , fontSize:"20px" , fontWeight:"100"}}>|</span></span>
                                <span  style={{margin:"0px 4px" }}>Make <span  style={{margin:"0px 6px" , fontSize:"20px" , fontWeight:"100"}}>|</span></span>
                                <span  style={{margin:"0px 4px" }}>Model <span  style={{margin:"0px 6px" , fontSize:"20px" , fontWeight:"100"}}>|</span></span>
                                <span  style={{margin:"0px 4px" }}>BodyStyle <span  style={{margin:"0px 6px" , fontSize:"20px" , fontWeight:"100"}}>|</span></span>
                                <span  style={{margin:"0px 4px" }}>Price <span  style={{margin:"0px 6px" , fontSize:"20px" , fontWeight:"100"}}>|</span></span>
                            </h2>

                            <div className="flex items-center">
                                <button style={{fontSize:"22.5px" }}  className="p-2  rounded hoverr"><i className="fa-solid fa-list"></i></button>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-semibold mb-4">Search</h2>
>>>>>>> 3ffc9d2 (Updated with new pages and latest changes)
            </div>
            <form className="space-y-4" style={{ marginTop: "-30px" }}>
              <div className="relative w-[100%] mt-6">
                <select
