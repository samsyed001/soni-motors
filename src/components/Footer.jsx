...
const Footer = () => {
  return (
    <>
<div className="footer-back-img mt-5 p-5 mb-10">
  <div className="mx-auto px-[45px] mb-10">
    <img src="./assets/soni_auto_1 1.png" alt="" />
  </div>
  <div className="footerr  text-white">
    <div style={{marginRight:'70px'}} className=" FOOTER-DIV">
      ...
      <img  src="./assets/tiktok12.png" alt="" />
